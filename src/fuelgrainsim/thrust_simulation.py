...
def regression(shape,variables):
    ...
    Parameters:
        ...
        variables (list): A list of variables to calculate the regression for.
...
def thrust(area,variables):
    ...
    Parameters:
        ...
        variables (list): A list of variables to calculate the thrust for.
...
def write_csv(data_frame,destination):
    ...
    Parameters:
        ...
        destination: The name of the CSV file.
...
def file_args():
    ...
    parser.add_argument('--n', type=float, help='Enter regression coefficient n', required=True)
    ...
    arg_list = [args.input, args.output, args.isp, args.a, args.n, args.density, args.flow, args.length, args.iterations, args.time, args.log_level]
    return arg_list
...
def generate(file,variables):
    ...
    Parameters:
        ...
        variables (list): A list of the variables to extract from the SVG file.
...
def run(each,folder,variables):
    ...
    Parameters:
        ...
        variables (list): A list of variables used to generate the thrust curve.
...
def run_simulation(input_folder: str, output_folder: str, isp: str, a: str, n: str, density: str, flow: str, length: str, iterations: str, time: str, log_level: str = "ERROR"):
    """
    ...
    Parameters:
        ...
        isp (str): Initial specific impulse of rocket
        a (str): Regression coefficient a for marxman regression
        n (str): Regression coefficient n for marxman regression
        density (str): Density of fuel (kg/m^3)
        flow (str): Oxidiser mass flow rate (kg/s)
        length (str): Length of rocket fuel grain (m)
        iterations (str): Number of iterations per second of fire time
        time (str): Total simulation time (s)
    ...
    variable_list = [float(isp),float(a),float(n),float(density),float(flow),float(length),float(iterations),float(time)]
